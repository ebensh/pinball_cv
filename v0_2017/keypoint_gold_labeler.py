...
def main():
  global mouse_info
  game_config = configparser.ConfigParser(defaults={'video_base': args.video_base})
...
if __name__ == '__main__':
  ...
  parser.add_argument('--video_base', required=True, type=str, help='Specific video file name base, e.g. hot_hand_ebensh_2017_11_27')
